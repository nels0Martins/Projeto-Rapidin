...
<html lang="pt-br">
    <head>
        ...
        <link rel="shortcut icon" href="assets/logo-a.png" type="image/x-icon">
        <!------------------>
    </head>
    <body>
        ...
        <header class="nave">
            ...
            <!-- LOGO -->
            <section class="logo">
                <a href="#"><img src="assets/logo_rapidin.png" alt="Logo do Rapidin"></a>
            </section>
            ...
            <!--
                <article class="box_login">
                    <a href="entrar.php"><button class="login">LOGIN</button></a>
                </article>
                
                <article class="box_cadastro">
                    <a href="criarConta.php"><button class="cadastro">CADASTRO</button></a>
                </article>
            
            -->

            <p class="botoes-p">Bem vindo!</p>
        ...
        <section class="sobre" id="SOBRE">
            ...
            <section class="box_sobre_um">
                ...
                <article class="sobre_um_logo">
                    <img src="assets/detetive.svg" alt="Procurando por motorista">
                </article>
            ...
            <section class="box_sobre_dois">
                ...
                <article class="sobre_dois_logo">
                    <img src="assets/suporte.svg" alt="O suporte do Rapidin é nota 10!">
                </article>
        ...
        <section class="beneficios" id="BENEFICIOS">
            ...
            <section class="box_um_maxter">
                ...
                <article class="box_um_bene">
                    <img src="assets/comunidade.png" alt="Comunidade">
                ...
                <article class="box_tres_bene">
                    <img src="assets/energia-sustentavel (1).png" alt="Energia Sustentavel">
            ...
            <div style="display: flex; justify-content: center;">
                <section class="box_quatro_bene">
                    <img src="assets/pratico.png" alt="Rápido e prático">
            ...
            <section class="box_baixar" id="BAIXAR">
                ...
                <div class="baixar-one-center">
                    <article class="box_baixar_one">
                        <img src="assets/dois-celulares__1_-removebg-preview.png" alt="Dois celulares com o Rapidin">
                    </article>
                    <article class="box_baixar_two">
                        <h1>Se cuida, vai de Rapidin.</h1>
                        <h2>Baixe o app e viaje de maneira rápida, simples e segura.</h2>
                        <div class="app">
                            <img src="assets/playstore.png" alt="" class="plstore">
                            <img src="assets/appstore.png" alt="" class="apstore">
                        </div>
            ...
            <div class="pezin">
                ...
                <footer class="pe">
                    ...
                    <img src="assets/logo-a.png" alt="Logo do Rapidin">
                    <ul>
                        <li><a href="index.php">INÍCIO</a></li>
                        <li><a href="#SOBRE">SOBRE</a></li>
                        <li><a href="#BENEFICIOS">BENEFÍCIOS</a></li>
                    ...
                    <section class="direitos">
                        <p style="color: white;">&copy; 2023 Copyright Todos os direitos reservados <a href="usuarios.php"><span style="color: #6DD37D;">Rapidin</span></a>.</p>
                    </section>
